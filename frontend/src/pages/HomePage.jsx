        ...
        <div className="features-container">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p>Shot-list, референсы, таймлайн и версии материалов под рукой у всей команды.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">💬</div>
            ...
            <div className="feature-card">
              ...
              <p>Роли, приватные проекты и защищенное хранение производственных данных.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="about-section">
        <div className="about-container">
          <div className="about-content">
            ...
            <p>
              Платформа создана для реального продакшна: от таблиц смен и call sheet до контроля правок в посте.
              Меньше хаоса в коммуникации, больше фокуса на результате.
            </p>
            <div className="stats">
              <div className="stat">
